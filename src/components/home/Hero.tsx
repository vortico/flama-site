  ...
  return (
    <section className="mx-auto max-w-5xl px-6 pt-40 text-center md:px-8 md:pt-48 lg:pt-52">
      ...
      <div className="mt-10 flex justify-center gap-6 text-sm sm:mt-10">
        <Link href="/docs/">
          <a className="dark:highlight-white/20 flex h-12 w-full items-center justify-center rounded-full bg-brand-500 px-6 font-semibold text-primary-100 hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:ring-offset-2 focus:ring-offset-brand-50 dark:bg-brand-500 dark:hover:bg-brand-400 sm:w-auto">
            Get Started
          </a>
        </Link>
