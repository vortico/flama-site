...
app = Flama()
app.mcp.add_server("/mcp/tools/", "tools", version="2.0.0", instructions="Demo MCP tools server")
...
Any MCP-capable client (Claude, Cursor, VS Code Copilot, custom agents) can discover and invoke these capabilities
through the standard JSON-RPC interface. No bespoke integration code required.
