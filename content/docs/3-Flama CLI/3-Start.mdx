...
characteristics, <FlamaName /> introduces the concept of definition files.
A definition file allows you to have all the specs related with the deployment of an ML API as code.
