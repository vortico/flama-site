...
All models served with **flama serve** come with the following end points for free:
...
<Image src="/images/docs/docs-schema-get.png" alt="docs-get-schema" width="800" height="200" />
...
<Image src="/images/docs/docs-predict-post.png" alt="docs-post-predict" width="800" height="380" />
...
<Image src="/images/docs/docs-serve-params.png" alt="docs-post-predict" width="800" height="456" />
