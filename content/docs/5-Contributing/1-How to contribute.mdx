...
all tests are passing when submitting a pull request. Last, but not least, if you're adding new features to

<FlamaName />, you need to include the tests required.
